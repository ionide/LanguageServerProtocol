module Ionide.LanguageServerProtocol.Tests.Highlighting
...
let tests state =
  ...
  testSequenced <| testList "Document Highlighting Tests" [
    testList "tests" [
      ...
      tokenIsOfType (21, 2) ClassificationUtils.SemanticTokenTypes.Namespace fullHighlights // tests that module coloration isn't overwritten by function coloration when a module function is used
    ]

...
type private UnitInnerConverter() =
  ...
  override _.Write(writer, _value, _opts) = writer.WriteNullValue()
...
type UnitConverterFactory() =
  ...
  override _.CreateConverter(_t, _opts) = UnitInnerConverter() :> System.Text.Json.Serialization.JsonConverter

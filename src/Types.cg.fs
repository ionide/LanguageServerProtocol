        ...
        Cells:
            {| Structure:
                {| Array: NotebookCellArrayChange
                   ...
                   DidClose: TextDocumentIdentifier[] option |} option
               Data: NotebookCell[] option
               TextContent:
                   {| Document: VersionedTextDocumentIdentifier
                      Changes: TextDocumentContentChangeEvent[] |}[] option |} option
    }
...
type ServerCapabilities =
    {
        ...
        Workspace:
            {| WorkspaceFolders: WorkspaceFoldersServerCapabilities option
               FileOperations: FileOperationOptions option |} option
...
type GeneralClientCapabilities =
    {
        ...
        StaleRequestSupport:
            {| Cancel: bool
               RetryOnContentModified: string[] |} option
...
type CompletionClientCapabilities =
    {
        ...
        CompletionItem:
            {| SnippetSupport: bool option
               ...
               LabelDetailsSupport: bool option |} option
...
type SignatureHelpClientCapabilities =
    {
        ...
        SignatureInformation:
            {| DocumentationFormat: MarkupKind[] option
               ...
               ActiveParameterSupport: bool option |} option
        /// The client supports to send additional context information for a

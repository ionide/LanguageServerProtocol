...
///
/// @since 3.17.0
type TextDocumentFilter = {| Language: string option; Scheme: string option; Pattern: string option |}
...
///
/// @since 3.17.0
type NotebookDocumentFilter = {| NotebookType: string option; Scheme: string option; Pattern: string option |}
